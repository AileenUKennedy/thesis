...
set totalNodes age0-4 + age5-14 + age15-44 + age45+
...
to make-turtles
  ...
  create-infants age0-4[
    setxy( random-xcor * 0.95) (random-ycor * 0.95)
    set-susceptible
  ]
   create-youths age5-14[
    setxy( random-xcor * 0.95) (random-ycor * 0.95)
    set-susceptible
  ]
   create-adults age15-44[
    setxy( random-xcor * 0.95) (random-ycor * 0.95)
    set-susceptible
  ]
   create-elders age45+[
